...
const ossOpts = {
  app_id: "LTAI69b3DYhC7xxxxxx",
  bucket: "jiangniu-dev",
  dir: "uploads/business_plan/20190924/",
  expire: 1569207251,
  policy:
    "eyJssssccleHBpcmF0aW9uIjoiMjAxOS0wOS0yNFQxMDowMDo1MloiLCJjb25kaXRpb25zIjpbWyJjb250ZW50LWxlbmd0aC1yYW5nZSIsMCwxMDQ4NTc2MDAwXSxbInN0YXJ0cy13aXRoIiwiJGtleSIsInVwbG9hZHNcL2J1c2luZXNzX3BsYW5cLzIwMTkwOTI0XC8iXV19",
  region: "oss-cn-shenzhen",
  showurl: "http://jiangniu-dev.oss-cn-shenzhen.aliyuncs.com",
  signature: "Tc9wLBk+konkktBlA7EHqsbdsLExS5A="
};
export default {
